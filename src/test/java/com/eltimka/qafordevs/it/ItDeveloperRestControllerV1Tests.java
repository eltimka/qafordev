package com.eltimka.qafordevs.it;

import com.eltimka.qafordevs.dto.DeveloperDto;
...
public class ItDeveloperRestControllerV1Tests  extends AbstractRestControllerBaseTest{
  ...
  @Autowired
    ...
    public void givenId_whenGetById_thenSuccessResponse() throws Exception {
        ...
        developerRepository.save(developer);
        //when
        ResultActions result = mockMvc.perform(get("/api/v1/developers/1" + developer.getId())
                .contentType(MediaType.APPLICATION_JSON));
        //then
        result
                .andDo(MockMvcResultHandlers.print())
    ...
    public void givenId_whenSoftDelete_thenSuccessResponse() throws Exception {
     ...
     developerRepository.save(developer);
        //when
        ResultActions result = mockMvc.perform(delete("/api/v1/developers/1" + developer.getId())
                .contentType(MediaType.APPLICATION_JSON));
        //then
